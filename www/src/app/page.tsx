...
export default async function Home() {
	...
	const about = `A bejgli tésztájához a langyos tejben feloldjuk a porcukrot, majd az élesztőt felfuttatjuk benne.A vajat kis tálban felolvasztjuk. A lisztet tálba szitáljuk. Hozzáadjuk először az élesztős tejet és 2 db tojássárgáját, majd a vajat és a sót, végül a reszelt citromhéjat.
	![Leírás](/images/1.png "Alt")
	...
	return (
		<main className="flex flex-col pt-3">
			...
			<div className="mx-6 -mb-6 px-6 pt-6 pb-6 grid grid-cols-5 justify-between
			items-end gap-x-4 gap-y-2 rounded-t-3xl text-black/75 bg-[#BABEAE]">
				...
				<div className="flex flex-col items-start col-span-5 md:col-span-2">
					...
					<Input
						...
						border-transparent transition-colors w-full"
					/>
				</div>
				<button
					type="submit"
